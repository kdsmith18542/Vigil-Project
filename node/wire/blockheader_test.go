...
func TestBlockHeader(t *testing.T) {
	...
	mixDigest := [32]byte{0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef}
...
func TestBlockHeaderWire(t *testing.T) {
	...
	baseBlockHdrEncoded := []byte{
		...
		0xf3, 0xe0, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, // Nonce (uint64)
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
...
func TestBlockHeaderSerialize(t *testing.T) {
	...
	baseBlockHdrEncoded := []byte{
		...
		0xf3, 0xe0, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, // Nonce (uint64)
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest (cont.)
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest (cont.)
		0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest (cont.)
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ExtraData
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
