...
func TestBlock(t *testing.T) {
	...
	bh := NewBlockHeader(
		...
		uint32(1),                                   // Height
		uint32(1),                                   // Size
		time.Unix(0x495fab29, 0),                    // Timestamp (2009-01-03 12:15:05 -0600 CST)
		uint64(testBlock.Header.Nonce),             // Nonce (converted to uint64)
		[32]byte{0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest
...
var testBlock = MsgBlock{
	Header: BlockHeader{
		...
		Nonce:        uint64(0x9962e301),       // 2573394689
		MixDigest: [32]byte{0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest
		                  0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
		                  0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
		                  0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef},
		ExtraData:    [32]byte{},
...
var testBlockBytes = []byte{
	...
	0x01, 0xe3, 0x62, 0x99, 0x00, 0x00, 0x00, 0x00, // Nonce (uint64) [140]
	0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest [148]
	0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest (cont.) [156]
	0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest (cont.) [164]
	0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, // MixDigest (cont.) [172]
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ExtraData [180]
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ExtraData (cont.) [188]
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ExtraData (cont.) [196]
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ExtraData (cont.) [204]
	0x1e, 0xab, 0xa1, 0x5c, // StakeVersion [212]
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Previous output hash [222]
	0xff, 0xff, 0xff, 0xff, // Previous output index [254]
	0x00,                   // Previous output tree [258]
	0xff, 0xff, 0xff, 0xff, // Sequence [259]
	0x01,                                           // Varint for number of transaction outputs [263]
	0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, // Transaction amount [264]
	0x98, 0x98, // Script version [272]
	0x43, // Varint for length of pk script [274]
	0x41, // OP_DATA_65
	0x04, 0x96, 0xb5, 0x38, 0xe8, 0x53, 0x51, 0x9c,
	0x72, 0x6a, 0x2c, 0x91, 0xe6, 0x1e, 0xc1, 0x16,
	0x00, 0xae, 0x13, 0x90, 0x81, 0x3a, 0x62, 0x7c,
	...
	0x22, 0x94, 0x72, 0x11, 0x66, 0xbf, 0x62, 0x1e,
	0x73, 0xa8, 0x2c, 0xbf, 0x23, 0x42, 0xc8, 0x58,
	0xee,                   // 65-byte signature [339]
	0xac,                   // OP_CHECKSIG [340]
	0x11, 0x11, 0x11, 0x11, // Lock time [341]
	0x22, 0x22, 0x22, 0x22, // Expiry [345]
	0x01,                                           // Varint for number of signatures [349]
	0x16, 0x16, 0x16, 0x16, 0x16, 0x16, 0x16, 0x16, // ValueIn [350]
	0x17, 0x17, 0x17, 0x17, // BlockHeight [358]
	0x18, 0x18, 0x18, 0x18, // BlockIndex [362]
	0x07,                                     // SigScript length [366]
	0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0xf2, // Signature script (coinbase) [367]
	// Announce number of stake txs
	0x01, // TxnCount for stake tx [374]
	// Begin bogus stake txs
	0x01, 0x00, 0x00, 0x00, // Version [375]
	0x01, // Varint for number of transaction inputs [379]
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Previous output hash [380]
	0xff, 0xff, 0xff, 0xff, // Previous output index [412]
	0x01,                   // Previous output tree [416]
	0xff, 0xff, 0xff, 0xff, // Sequence [417]
	0x01,                                           // Varint for number of transaction outputs [421]
	0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, // Transaction amount [422]
	0x12, 0x12, // Script version [430]
	0x43, // Varint for length of pk script [432]
	0x41, // OP_DATA_65
	0x04, 0x96, 0xb5, 0x38, 0xe8, 0x53, 0x51, 0x9c,
	0x72, 0x6a, 0x2c, 0x91, 0xe6, 0x1e, 0xc1, 0x16,
	0x00, 0xae, 0x13, 0x90, 0x81, 0x3a, 0x62, 0x7c,
	...
	0x22, 0x94, 0x72, 0x11, 0x66, 0xbf, 0x62, 0x1e,
	0x73, 0xa8, 0x2c, 0xbf, 0x23, 0x42, 0xc8, 0x58,
	0xee,                   // 65-byte signature [497]
	0xac,                   // OP_CHECKSIG [498]
	0x11, 0x11, 0x11, 0x11, // Lock time [499]
	0x22, 0x22, 0x22, 0x22, // Expiry [503]
	0x01,                                           // Varint for number of signatures [507]
	0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, // ValueIn [508]
	0x14, 0x14, 0x14, 0x14, // BlockHeight [516]
	0x15, 0x15, 0x15, 0x15, // BlockIndex [520]
	0x07,                                     // SigScript length [524]
	0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0xf2, // Signature script (coinbase) [525]
}
