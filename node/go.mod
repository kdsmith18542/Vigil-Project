...
require (
	...
	github.com/decred/dcrd/database v1.1.0 // indirect
...
replace (
	github.com/decred/dcrd/internal/kawpow => ./blockchain/standalone/kawpow
	github.com/decred/dcrd/internal/rpcserver/types => ./internal/rpcserver/types
	github.com/decred/dcrd/syncmgr => ./syncmgr
)
